...
> Designed with a cyberpunk/Y2K aesthetic featuring custom color palettes, distortion effects, and responsive mobile-first controls.
...
- **🖼️ Halftone & CRT FX:** Customizable halftone dot overlays, CRT scanlines, grain, and radial vignette.
- **𝔄 Cyberpunk Typography:** Render styled title and subtitle overlays with adjustable RGB glitch distortion.
